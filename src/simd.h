...
namespace bla_ga
{
  ...
  public:
    ...
    T &operator[](size_t i) { return Ptr()[i]; }      // non-const
    T operator[](size_t i) const { return Ptr()[i]; } // const version
  ...
  public:
    ...
    T &operator[](size_t i) { return val; }      // non-const
    T operator[](size_t i) const { return val; } // const
  };
